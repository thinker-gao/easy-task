                    ...
                    <div class="divstep4" style="display: none">
                        <div class="content">
                            ...
                            <div class="end" style="margin-left:80px;"><h3>恭喜,您的网站已安装完成！</h3>
                                <p>首页地址：<a href="http://haiyang.cn" target="_blank">http://haiyang.cn</a>
                                    <br>后台地址：<a href="http://haiyang.cn/thydak"
                                                target="_blank">http://haiyang.cn/thydak</a>
                                    <br>用户名：admin <br>密　码：admin <br>请牢记以上信息，您可以登陆后台修改密码及网站设置。</p>
                            </div>
                        </div>
                        <div class="button"><a href="../" target="_blank">访问网站</a></div>
                    </div>
